...
public class WindDirSensor extends AbstractSensor {
    ...
    public WindDirSensor(DSPortAdapter adapter, String windDirDeviceID, Properties ps) {
        ...
        this.device = (OneWireContainer)windDirDevice;
...
// convert direction value into compass direction string
    ...
    public void updateAverage(int windDir) {
        if (windDir == 16) {
            return;
        }
    ...
    public void update() {
        try {
            ...
            System.out.println("Wind direction = " + getWindDirStr(windDir));
            updateAverage(windDir);
