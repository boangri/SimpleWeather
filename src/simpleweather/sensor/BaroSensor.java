 ...
 * ****************************************************************************
 *
 * Project Name: SimpleWeather File name: BaroSensor.java Version: 1.0.2
 * 02/21/06 $Id: BaroSensor.java,v 1.1.1.1 2010/02/19 15:34:24 boris Exp $
 *
...
public class BaroSensor extends AbstractSensor {
  ...
  //private static boolean debugFlag = SimpleWeather.debugFlag;
    ...
    public BaroSensor(DSPortAdapter adapter, String deviceID, Properties ps) {
        ...
        this.device = (OneWireContainer)baroDevice;
